...
The option source is [`nix/hm-module.nix`](https://github.com/caniko/modde-rs/blob/trunk/nix/hm-module.nix);
the typed tool-settings schema is generated into
[`nix/tool-schema.nix`](https://github.com/caniko/modde-rs/blob/trunk/nix/tool-schema.nix)
...
[`nix/release-supporting-tools.nix`](https://github.com/caniko/modde-rs/blob/trunk/nix/release-supporting-tools.nix));
...
[`nix/optiscaler-profiles.nix`](https://github.com/caniko/modde-rs/blob/trunk/nix/optiscaler-profiles.nix)),
